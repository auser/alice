...
get_user() ->
    http:request(get, {"http://localhost:999/user/12345", []}, [], []).
...
update_user() ->
    ...
    http:request(post, {"http://localhost:9999/user/12345", [], "application/xml", Data}, [], []).

delete_user() ->
    http:request(delete, {"http://localhost:9999/user/12345", []}, [], []).
...
create_user() ->
    ...
    http:request(put, {"http://localhost:9999/user/", [], "application/xml", Data}, [], []).
